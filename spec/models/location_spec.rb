...
RSpec.describe Location do
  ...
  it "requires a market location id to be exactly 10 digits" do
    ...
    expect(location.errors[:location_id]).to include("must be exactly 10 digits")
  ...
  it "requires a metering location id to be exactly 33 characters" do
    ...
    expect(location).not_to be_valid
    expect(location.errors[:location_id]).to include("is the wrong length (should be 33 characters)")
